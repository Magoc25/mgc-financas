...
[![Versão](https://img.shields.io/badge/versão-4.19.0-blue)](#changelog)
...
- **Compras nos cartões por dia** — acumulado dia a dia, uma linha por cartão; os degraus mostram em que dias você concentra os gastos
